...
### 🛡️ Обход блокировок (13)
WARP Proxy (SOCKS5), WebSocket, gRPC, ShadowTLS, Reality, Hysteria 2, Tuic, WireGuard, SOCKS5 Dante, Shadowsocks 2022, Naive Proxy, Cloak, VLESS Reality (автоконфигурация)
...
- 🆕 **Shadowsocks 2022** — новая версия с улучшенной безопасностью
- 🆕 **Naive Proxy** — маскировка под Chrome трафик
- 🆕 **Cloak** — маскировка под обычный HTTPS
- 🆕 **VLESS Reality** — автоматическая генерация ключей и конфигурации
